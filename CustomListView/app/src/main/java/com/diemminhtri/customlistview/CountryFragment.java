...
public class CountryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_country2, container, false);
        ...
        imageViewFlag.setImageResource(     getMimapResId(data.getCountryFlag()));

        return view;
    }
    private  int getMimapResId(View itemView, String mimapName) {
        String
    }
}